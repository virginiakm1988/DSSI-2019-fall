...
cat("Michael","Jackson\n")
print(paste("Michael","Jackson", sep = " "))
...
df_country<-data.frame(country,import, export)
df_country<-df_country[order(-df_country$export, -df_country$import),]
df_country
